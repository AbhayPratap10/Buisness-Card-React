...
export default function Header(){
    return(
        <div className="header-container">
            <img src="./image/me.jpg" alt="an-dummy-image-of-me"/>
            <h1 className="header-name">Abhay Pratap Singh</h1>
            <p className="header-post">Frontend Developer</p>
            <a className="header-site" href="#">aps.website</a>
            <div className="btn-container">
   
                <button className="btn email-btn">         <svg width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12.9 3.49441L6.50001 6.69441L0.100006 3.49441V8.20001C0.100006 8.62436 0.268577 9.03133 0.568635 9.33138C0.868693 9.63144 1.27566 9.80001 1.70001 9.80001H11.3C11.7244 9.80001 12.1313 9.63144 12.4314 9.33138C12.7314 9.03133 12.9 8.62436 12.9 8.20001V3.49441Z" fill="#1E1F26"/>
                ...
                <button className="btn linkedIn-btn"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
